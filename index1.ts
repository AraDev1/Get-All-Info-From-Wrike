...
var task: dataGift<wrikeTask>;
var contacts: dataGift<wrikeContacts>;
var folders: dataGift<wrikeFolders>;

var token = process.env.WRIKE_TOKEN;
...
async function main(): Promise<void> {
  ...
  fs.writeFile('fullfold.json', JSON.stringify(finalFolder, null, 2), () => {})
}
